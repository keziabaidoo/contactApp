...
export default function MyProfileScreen(navigation){
    return(
        ...
        <Image source={require('../../assets/girly.jpg')} style={Styles.imageText1}/>
        <Text style={Styles.Input1}>Princess Oteng</Text>
        <Text style={Styles.InText}>Head Of Marketing</Text>
    </View>
